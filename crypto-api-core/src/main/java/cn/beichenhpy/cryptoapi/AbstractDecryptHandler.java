...
public abstract class AbstractDecryptHandler implements CryptoHandler {
    ...
    public abstract HttpInputMessage decryptRequestBody(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType, Class<? extends HttpMessageConverter<?>> converterType);
